 ...
 */
public abstract class NfcTransactionManager extends TransactionManager {
    ...
    public NfcTransactionManager(Web3j web3j, String fromAddress, MifareUltralight tag, String publicKey, Activity activity) {
